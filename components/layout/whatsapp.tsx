...
export default function WhatsAppContact() {
    ...
    return (
      ...
      `}</style>
            ...
            {/* ── Backdrop ── */}
            <div className={`wa-backdrop${popupOpen ? " open" : ""}`} onClick={handleClose} />

            {/* ── Popup ── */}
            <div className={`wa-popup${popupOpen ? " open" : ""}`} role="dialog" aria-modal="true" aria-label="WhatsApp chat">
                ...
                <div className="wa-popup-header">
                    ...
                    <button className="wa-close-btn" onClick={handleClose} aria-label="Close">✕</button>
                </div>
                    ...
                    <div className="wa-bubble-wrap">
                        <div className="wa-bubble">
                            <p className="wa-bubble-text">
                                👋 Hi there! Ready to start planning your dream wedding?<br /><br />
                                Click <strong>Allow</strong> to open WhatsApp and chat with our planner directly.
                            </p>
                    ...
                    {redirecting ? (
                        ...
                        <>
                            ...
                            <div className="wa-actions">
                                ...
                                <button className="wa-cancel" onClick={handleClose}>Cancel</button>
                            </div>
                        </>
                    )}

                    <p className="wa-privacy">🔒 Your details are safe. We never share your info.</p>
                </div>
            </div>
        </>
    );
